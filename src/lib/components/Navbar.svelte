...
<div class="navbar flex bg-black fixed top-0 justify-between z-40  ">
  <div class="flex-initial h-auto w-auto m-2 mb-4 grid grid-flow-col gap-4">
  ...
  <div class="flex-initial m-2 mb-4 w-auto right-0">
