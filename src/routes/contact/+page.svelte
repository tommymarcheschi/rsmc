  ...
  <div class="flex flex-col items-center justify-center w-4/5 lg:w-3/5 mt-2 text-left">
    ...
    <div class="grid gap-6 sm:grid-cols-2">
      <div class="relative z-0">
        <input bind:value={name} type="text" name="name" class="peer block w-full appearance-none border-0 border-b border-gray-100 bg-transparent py-2.5 px-0 text-sm text-white focus:border-white focus:outline-none focus:ring-0" placeholder=" " />
      ...
      <div class="relative z-0">
        <input bind:value={email} type="text" name="email" class="peer block w-full appearance-none border-0 border-b border-gray-100 bg-transparent py-2.5 px-0 text-sm text-white focus:border-white focus:outline-none focus:ring-0" placeholder=" " />
