...
<div class="space-y-8">
	...
	<div>
		...
		<p class="mt-1 text-vault-text-muted">Your Pokémon TCG portfolio at a glance</p>
	</div>

	<!-- Stats Grid -->
	<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
		<div class="stat-card rounded-2xl border border-vault-border bg-vault-surface p-6">
			...
			<p class="mt-3 text-3xl font-bold text-vault-gold">${stats.totalInvested.toFixed(2)}</p>
		...
		<div class="stat-card rounded-2xl border border-vault-border bg-vault-surface p-6">
			...
			<p class="mt-3 text-3xl font-bold text-white">{stats.totalCards}</p>
		...
		<div class="stat-card rounded-2xl border border-vault-border bg-vault-surface p-6">
			...
			<p class="mt-3 text-3xl font-bold text-white">{stats.watchlistCount}</p>
		...
		<div class="stat-card rounded-2xl border border-vault-border bg-vault-surface p-6">
			...
			<p class="mt-3 text-3xl font-bold text-white">{stats.gradingPending}</p>
	...
	<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
		<div class="rounded-2xl border border-vault-border bg-vault-surface p-6">
			...
			<div class="mt-4 grid grid-cols-2 gap-3">
				<a
					href="/browse"
					class="btn-press group flex items-center gap-3 rounded-xl border border-vault-border bg-vault-bg p-4 transition-all hover:border-vault-purple/50 hover:bg-vault-surface-hover"
				>
					<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-vault-purple/10 transition-colors group-hover:bg-vault-purple/20">
				...
				<a
					href="/collection"
					class="btn-press group flex items-center gap-3 rounded-xl border border-vault-border bg-vault-bg p-4 transition-all hover:border-vault-green/50 hover:bg-vault-surface-hover"
				>
					<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-vault-green/10 transition-colors group-hover:bg-vault-green/20">
				...
				<a
					href="/watchlist"
					class="btn-press group flex items-center gap-3 rounded-xl border border-vault-border bg-vault-bg p-4 transition-all hover:border-vault-cyan/50 hover:bg-vault-surface-hover"
				>
					<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-vault-cyan/10 transition-colors group-hover:bg-vault-cyan/20">
				...
				<a
					href="/grading"
					class="btn-press group flex items-center gap-3 rounded-xl border border-vault-border bg-vault-bg p-4 transition-all hover:border-vault-gold/50 hover:bg-vault-surface-hover"
				>
					<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-vault-gold/10 transition-colors group-hover:bg-vault-gold/20">
